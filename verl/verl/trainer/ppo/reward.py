...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    elif reward_manager_name == "rllm":
        from verl.workers.reward_manager import DeepscalerRewardManager
        reward_manager_cls = DeepscalerRewardManager
    elif reward_manager_name == "mix_rllm":
        from verl.workers.reward_manager import MixDeepscalerRewardManager
        reward_manager_cls = MixDeepscalerRewardManager
    elif reward_manager_name == "kk":
        from verl.workers.reward_manager import LogicKKRewardManager
        reward_manager_cls = LogicKKRewardManager
    elif reward_manager_name == "simple_rl":
        from verl.workers.reward_manager import SimpleRewardManager
        reward_manager_cls = SimpleRewardManager
    else:
