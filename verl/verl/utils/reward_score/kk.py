...
#     try:
#         final_answer = processed_str.split("solution:\n")[1]
#     except:
...
def extract_solution(solution_str: str, is_response: bool = False) -> Tuple[Optional[str], str]:
    """Extracts the final answer from the model's response string.
...
def compute_score(solution_str: str, 
    ...
    # Extract model answer
    answer_text, processed_str = extract_solution(solution_str, is_response=is_response)
